...
$page = [
    'title'       => 'About HabeshAir — Premium Air Charter Coordination',
    'description' => 'HabeshAir is a premium air charter coordination platform connecting Africa to the world. VIP, cargo, humanitarian, and emergency missions through certified operators.',
...
<section class="hero" style="padding:3.5rem 0 4rem">
  <div class="container">
    ...
    <p class="lede">HabeshAir connects Africa to the world. We specialize in time-critical, complex, and high-value aviation missions — coordinated through certified operators we know and trust.</p>
  </div>
</section>
...
<section class="section">
  <div class="container prose">
    ...
    <p>HabeshAir earns a coordination fee included in the operator quote. We do not charge clients to submit a request, receive a quote, or talk to a coordinator. If we cannot find a suitable option for your mission, we tell you — and we tell you why.</p>
